            ...
            {[
              {
                ...
                a: "Each token is analyzed by 4 independent LLMs (ChatGPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro, Grok 4) using game theory principles. The final score (0-100) is a weighted consensus. 70+ = BUY, 40-69 = HOLD, <40 = SELL.",
              },
              {
